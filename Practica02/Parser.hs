...
happyExpList = Happy_Data_Array.listArray (0,37) ([4208,4,0,60,7168,1796,1,3968,1052,49415,28737,49168,28673,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Prop","cons","var","'('","')'","and","or","impl","syss","not","%eof"]
...
happyReduction_1 (HappyTerminal (TokenCons happy_var_1))
	 =  HappyAbsSyn4
		 (Cons happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TokenCons happy_dollar_dollar -> cont 5;
